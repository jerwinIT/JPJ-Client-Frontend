        ...
        <Layout>
            <div className="container mt-5">
                ...
                <div className="d-flex justify-content-between align-items-center mb-3">
                        <div>
                            <button className="btn btn-success mr-3" onClick={toggleAddProduct} style={{ marginTop: "10px" }}>
                                Add Product
                            </button>
                            <button className="btn btn-info mr-3" onClick={toggleUpdatePrice} style={{ marginTop: "10px" }}>
                                Update Price
                            </button>
                            <button className="btn btn-info mr-5" onClick={toggleUpdateStock} style={{ marginTop: "10px" }}>
                                Update Stock
                            </button>
                            <button
